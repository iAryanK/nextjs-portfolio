      ...
      <div className="md:px-5">
        <div className="max-w-7xl mx-auto border rounded-lg relative mt-10">
          ...
          <div className="max-w-6xl mx-auto blogContent py-7 pl-3 pr-2">
            <div className="paraHead">Hello there!</div>I am a Computer Science
            Undergraduate, currently pursuing the degree of Bachelor of
            Technology. I am in last year of my four years course duration.{" "}
            <br />
            After completing my schooling till XII standard, I took admission in{" "}
            <span className="highlight">
              I K Gujral Punjab Technical University
            </span>
            , which is in located Punjab. I am doing B.Tech in computer Science
            and Engineering (CSE), which is fortunately in my realm of keen
            interest. Aspiring to become a{" "}
            <span className="highlight">Software Development Engineer</span>, I
            also love{" "}
            <span className="highlight">
            ...
            <br /> Won <strong className="highlight">First Prize Medal</strong>{" "}
            in Quiz Competition held in may organized by our College Coding
            Club. <br />
            ...
            framework.
            <div className="paraHead">Skills</div>- My technical skills include{" "}
            ...
            <strong className="highlight">scalable systems.</strong> <br />- The
            development tool that i am use to is{" "}
            ...
            Interested in learning new technologies and working on them, I also
            love programming and solving new problems by implementing the
            concepts of{" "}
            <strong className="highlight">
              data Structures and Algorithms
            </strong>
            ...
            about{" "}
            <strong className="highlight">Robotics and Machine Learning</strong>
